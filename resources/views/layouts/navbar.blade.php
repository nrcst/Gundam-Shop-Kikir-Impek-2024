<nav style="background-color: #c7b7a3;" class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a href="#" class="navbar-brand">
            <img src="{{ asset('assets/icongs.png') }}" alt="Logo" style="width: 60px;">
        </a>
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
                <a href="#" class="nav-link fw-bold">Sign Up</a>
            </li>
        </ul>
    </div>
</nav>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="#" class="nav-link fw-bold active"
                        style="border-bottom: 4px solid; border-radius: 4px;">HOME</a>
                </li>
                </li>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link fw-bold">SERVICE</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link fw-bold">HELP</a>
                </li>
            </ul>
        </div>
    </div>
